...
1. **Download the dylib:** Grab the latest `AntiDarkSwordUI.dylib` from the [**Releases**](https://github.com/EolnMsuk/AntiDarkSword-TrollStore/releases) tab of this repository.
2. **Inject:** Open [TrollFools](https://github.com/Lessica/TrollFools/releases/download/v4.2-227/TrollFools_4.2-227.tipa) on your device, select your target app, and inject the `AntiDarkSwordUI.dylib` file.
...
For maximum device security, please use this if jailbroken: **[AntiDarkSword (Rootless / Rootful)](https://github.com/EolnMsuk/AntiDarkSword)** - For iOS 15.0 – 17.0
